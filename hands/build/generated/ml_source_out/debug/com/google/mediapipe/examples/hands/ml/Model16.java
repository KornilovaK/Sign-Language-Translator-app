package com.google.mediapipe.examples.hands.ml;
...
public final class Model16 {
  @NonNull
  private final Model model;

  private Model16(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "model16.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Model16 newInstance(@NonNull Context context) throws IOException {
    return new Model16(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Model16 newInstance(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    return new Model16(context, options);
  }
